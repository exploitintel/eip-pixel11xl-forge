...
This guide is for the current `0.1.0-rc` qualification package on one exact Pixel 11
...
```text
eip-pixel11xl-forge-0.1.0-rc.9.zip
docker-29.8.0.tgz
...
2. Select `eip-pixel11xl-forge-0.1.0-rc.9.zip` in the module installer.
