...
KernelSU-Next qualification installer for the current module version. It no
...
python3 tools/assemble-module.py \
  ...
  --output /new/eip-pixel11xl-forge-0.1.0-rc.9.zip
```
...
versioned recovery kit under `/data/docker/recovery/0.1.0-rc.9` before
